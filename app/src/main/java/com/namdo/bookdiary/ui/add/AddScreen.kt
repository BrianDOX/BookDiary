...
import com.namdo.bookdiary.util.PickImage
...
fun AddCustomBookContent(
    ...
    Column(
        ...
        AsyncImage(
            model = if (imageUri.isEmpty()) R.drawable.book else imageUri,
                ...
                onClick = {
                    viewModel.addCustomBook(
                        Book(
                            ...
                            thumbnail = if (imageUri.isEmpty()) {"android.resource://com.namdo.bookdiary/${R.drawable.book}"} else {imageUri}
    ...
    Column(
        ...
        LazyColumn(
            ...
            items(viewModel.googleBooksSearchResult, key = { it.id }) {
                BookRow(it, isFromAddScreen = true) {
